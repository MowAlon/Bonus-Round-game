...
var Game = function(assets, sounds) {
  ...
  function runGame(context, board) {
    self.update(board)
    self.dropBombs(board, assets, sounds)
...
Game.prototype = {
  ...
  dropBombs: function(board, assets, sounds) {
  ...
  showStartScreen: function(context, board) {
    ...
    context.fillText("Use N-U-I-O-P to shoot.", centerOfGamePane.x, centerOfGamePane.y + 170)
  },
