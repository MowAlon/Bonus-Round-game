...
var Game = function(assets, canvas, context) {
  ...
  //   var bombsDestroyed = clearHeadBullets(this, board)
  //   clearShortBullets(board.playerBullets())
...
Game.prototype = {
  ...
  update: function(board) {
    // var bombsDestroyed = this.HandleAllCollisions(board)
    // this.players[0].addPoints(bombsDestroyed)
    // for (var i = 0; i < board.bullets.length; i++) {
    //   board.bullets[i].update()
    // }

    var bombsDestroyed = board.HandleAllCollisions(this)
    this.players[0].addPoints(bombsDestroyed)
    for (var i = 0; i < board.bullets.length; i++) {
      board.bullets[i].update()
    }
...
// function clearHeadBullets(self, board) {
//   var bombsDestroyed = 0
//   board.lanes.forEach(function(lane) {
//     var bullets = [lane.frontUpBullet(), lane.frontDownBullet()]
//     if (removeCollidingBullets(bullets)) {
//       self.assets.sounds.bulletsCollide.playSound()
//       bombsDestroyed++
//     }
//     clearOffScreenBullets(self, bullets)
//   })
//   return bombsDestroyed
// }
//
// function clearOffScreenBullets(self, bullets) {
//   bullets.forEach(function(bullet) {
//     if (bullet && offScreen(bullet)) {
//       var laneNumber = self.board.lanes.indexOf(bullet.lane)
//       var goodGuy = self.board.characters.good[laneNumber]
//       var badGuy = self.board.characters.bad[laneNumber]
//
//       self.assets.sounds.explosion.playSound()
//       bullet.destroyBullet()
//       if (bullet.velocity > 0) {
//         goodGuyHit(self, bullet, goodGuy)
//       } else {
//         badGuyHit(self, bullet, badGuy)
//       }
//     }
//   })
// }
...
// }
//
// function goodGuyHit(self, bullet, goodGuy) {
//   if (goodGuy.alive) {
//     goodGuy.alive = false
//     otherPlayer(self, bullet.player).reduceHealth(2)
//     self.assets.sounds.marioMamamia.playSound()
//   } else {
//     otherPlayer(self, bullet.player).reduceHealth(1)
//   }
// }
//
// function badGuyHit(self, bullet, badGuy) {
//   if (badGuy.alive) {
//     badGuy.alive = false
//     bullet.player.score += 50
//     self.assets.sounds.marioYippee.playSound()
//   } else {
//     bullet.player.score += 20
//     self.assets.sounds.marioHappy.playSound()
//   }
// }
//
//
