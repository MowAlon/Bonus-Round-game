...
function allSounds() {
  var sounds = {}
  sounds.bullet = new SoundPool(20, 'sounds/cannon_firing.mp3')
  sounds.explosion = new SoundPool(10, 'sounds/explosion.mp3')
  sounds.clang = new SoundPool(20, 'sounds/clang.mp3')
  return sounds
}
